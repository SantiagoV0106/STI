...
export function AlliancePage() {
    ...
    return (
        <section className="page-section">
            ...
            <p className="page-content"> <b>Remember</b> work together, answer right the question and move foward 5 squares each. If you fail you will have to move back 3 squares</p>
            <Button 
            type={'button'}
